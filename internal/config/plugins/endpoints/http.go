...
// http endpoint: anything that speaks TLS-wrapped HTTP. Covers most
...
// HTTPEndpoint is part of the clawpatrol plugin API.
...
func (e *HTTPEndpoint) EndpointHosts() []string { return e.Hosts }

// HTTPEndpointRuntime detects placeholders in an HTTP request's
...
type HTTPEndpointRuntime struct{}

// DetectPlaceholder is part of the clawpatrol plugin API.
func (HTTPEndpointRuntime) DetectPlaceholder(req *runtime.Request, candidates []string) string {
...
func init() {
	var _ runtime.PlaceholderDetector = HTTPEndpointRuntime{}
	config.Register(&config.Plugin{
		Kind:     config.KindEndpoint,
		Type:     "http",
		Family:   "http",
		New:      func() any { return &HTTPEndpoint{} },
		Runtime:  HTTPEndpointRuntime{},
